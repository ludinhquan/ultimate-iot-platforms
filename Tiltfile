...
# k8s_resource(api_resource('api-admin'), resource_deps=[
#  external_resource('rabbitmq'), 
#  external_resource('mongodb')
# ])

# k8s_resource(api_resource('service-datasource'), resource_deps=[
#  external_resource('rabbitmq'), 
#  external_resource('mongodb')
# ])
